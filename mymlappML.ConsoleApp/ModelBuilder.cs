...
namespace MymlappML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\mihai\Desktop\wikipedia-detox-250-line-data.tsv";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.BinaryClassification.Trainers.LinearSvm(new LinearSvmTrainer.Options() { Lambda = 0.04037051f, PerformProjection = true, NoBias = false, NumberOfIterations = 3, InitialWeightsDiameter = 0.9662406f, Shuffle = false, LabelColumnName = "Sentiment", FeatureColumnName = "Features" });
